...
class umozhigal extends Command {
	 ...
	 * @var string
	 */
	protected $description = 'Upadesa Mozhigal';
    ...
    public function fire() {
		...
		$view = '20150816-google-groups';
		$title = 'Moving to Google Groups for Announcements';
		//$view = '20150516-umozhigal';
		//$title = 'ஶ்ரீ ஶ்ரீ அண்ணாவின் உபதேச மொழிகள் - 11';
		...
		//$link = "http://srisrianna.com/announcement/kitta-anna-naama-bikshai/80741";
		...
		if ($groupId === "test") {
				...
				$this->info("Sending Test Email to me@thiru.in");
